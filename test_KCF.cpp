// 2017.4.6 by astraywu
// use video to test class KCF
#include <iostream>
#include <fstream>
#include <sstream>
#include <algorithm>
...
int main(int argc, char *argv[])
{
	...
	const std::string filename_video = "D:/Dataset/VehicleTracking/resources/videos_HD/DJI_0001.mov";
	...
	for (;;) {
		cap >> frame;
		if (!frame.data) {
			fprintf(stderr, "Warning: Read frame finished.\n");
			exit(-1);
		}
